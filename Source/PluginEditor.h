...
public:void mouseDrag(const juce::MouseEvent& e) override {setMouseDragSensitivity(e.mods.isShiftDown()?2400:240);juce::Slider::mouseDrag(e);}
};
class Editor final:public juce::AudioProcessorEditor,private juce::Timer {
 Processor& processor; RackLook look;
 ...
 float in=-100,out=-100,gr=0;int frame=0;
 void timerCallback() override;
public:explicit Editor(Processor&);~Editor() override;void paint(juce::Graphics&) override;void resized() override;
};
