...
int main(int argc,char** argv){juce::ScopedJuceInitialiser_GUI init;try{
 ...
 set("Attack",2.f/6);set("Release",3.f/5);p->getStateInformation(state);set("Attack",1);set("Release",0);p->setStateInformation(state.getData(),(int)state.getSize());
